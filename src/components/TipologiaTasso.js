  ...
  return (
    <div className='container px-10 py-5 mx-auto items-center text-center'>
      ...
      <div className='inline-flex items-center p-1 rounded-lg bg-gray-200 text-gray-800 w-1/3 text-center mb-5'>
        <span
          className={`cursor-pointer w-full px-4 py-2 rounded-lg ${
            isFisso && 'bg-red-500 text-white'
          }`}
        ...
        <div className='items-center justify-between w-full my-5'>
          ...
          <div className='rounded-full w-full h-11 flex mt-3'>
            ...
            <div
              ...
              } bg-yellow-500 flex-1 flex justify-center items-center`}
            >
              Media
            </div>
            <div
              ...
              } bg-green-500 rounded-r-full flex-1 flex justify-center items-center`}
            >
              Alta 😎
            </div>
          </div>
        ...
        <div className='items-center justify-between w-full my-5'>
          ...
          <div className='inline-flex w-full bg-white border border-gray-300 rounded'>
            {years.map((year, index) => (
              <button
                key={year}
                className={`flex-grow text-center py-2 ${selectedYear === year && 'bg-red-500 text-white'} border-r border-gray-300 ${index === 0 && 'rounded-l'} ${index === 5 && 'rounded-r'}`}
        ...
        <div className='items-center justify-between w-full my-5'>
          ...
          <div className='flex items-center justify-between w-full'>
            ...
            <div className="flex justify-center">
                <button className="w-12 h-12 rounded-full bg-[#eeeff1] text-black flex items-center justify-center hover:bg-[#cfcfcf] focus:outline-none text-4xl" onClick={() => handleImportoMutuo(1)}>
                    -
                </button>
                <button className="w-12 h-12 rounded-full bg-[#eeeff1] text-black flex items-center justify-center hover:bg-[#cfcfcf] focus:outline-none ml-2 text-4xl" onClick={() => handleImportoMutuo(0)}>
                    +
                </button>
            </div>
          </div>
        ...
        <div className='items-center justify-between w-full my-5'>
          ...
          <div className='flex items-center justify-between w-full'>
            <div className='flex items-center'>
              ...
              <span className='bg-[#cfcfcf] rounded-lg p-1 text-[12px] font-semibold text-[#505254]'> {percentImmobile} % </span>
            </div>
            <div className="flex justify-center">
                <button className="w-12 h-12 rounded-full bg-[#eeeff1] text-black flex items-center justify-center hover:bg-[#cfcfcf] focus:outline-none text-4xl" onClick={() => handleValoreImmobile(1)}>
                    -
                </button>
                <button className="w-12 h-12 rounded-full bg-[#eeeff1] text-black flex items-center justify-center hover:bg-[#cfcfcf] focus:outline-none ml-2 text-4xl" onClick={() => handleValoreImmobile(0)}>
                    +
                </button>
            </div>
          </div>
