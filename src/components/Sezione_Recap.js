...
function Recap() {
    ...
    const getCheckComponent = (itemId) => {
        if(itemId <= progress){
            return(
                ...
                <div id='item-3' className='flex my-4'>
                    ...
                    <div>
                        <div className='ml-5 text-left'>
                            ...
                            <a href='https://www.mutuiamo.it/' target='blank'>
                                <button class="bg-red-500 hover:bg-red-400 text-white py-2 px-4 rounded-lg w-full h-12 mt-5" onClick={() => { progress < 3 && setProgress(3) }}>
                ...
                <div id='item-4' className='flex mt-4'>
                    ...
                    <div>
                        <div className='ml-5 text-left'>
                            ...
                            <a href='https://www.mutuiamo.it/' target='blank'>
                                <button class="bg-white border border-black hover:border-red-500 hover:text-black text-red-500 py-2 px-4 rounded-lg w-full h-12 mt-5" onClick={() => { progress < 4 && setProgress(4) }} >
                                    <span className="text-center font-medium">
